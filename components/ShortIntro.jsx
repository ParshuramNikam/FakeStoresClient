...
const ShortIntro = () => {
    return (
        <section className="text-center mb-14">
            <h1 className="text-xl md:text-3xl px-2 font-medium mb-1">
                Get tired of Lorem ipsum data?!
            </h1>
            <h1 className="text-xl md:text-3xl px-2 font-medium mb-4">
                Didn't you find any free e-commerce API?!            </h1>
            <h3 className="text-md  md:text-lg  w-full mx-auto md:w-11/12">
