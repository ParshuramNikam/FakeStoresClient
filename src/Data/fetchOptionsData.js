...
const productData = [
    ...
    },
    {
        ...
        id: "p-sort",
        note: " Default value is in ascending mode, you can use with 'desc' or 'asc' as you want. Sorting is based on 'id'.",
        impNote: null,
        reqOptions: {
            method: "GET",
            headers: reqHeaders
...
const userData = [
    {
        ...
        impNote: "Nothing in real will insert into the database. It will return dummy response",
        cutOutput: false,
        output: {
            "desc" : "Nothing get added to DB",
    ...
    },
    {
        ...
        cutOutput: false,
        impNote: "It will not check for valid user into the database. It will return dummy login response with given credentials",
        output: {
    ...
    },
    {
        ...
        cutOutput: false,
        impNote: "It will not check for valid user into the database. It will return dummy logout response with given credentials",
        output: {
